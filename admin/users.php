...
<body>
    ...
    <nav class="main-nav">
        <div class="container nav-content">
            <div class="nav-left">
                <span class="nav-title"><i class="fas fa-users-cog"></i> User Management</span>
            </div>
            <div class="nav-right">
                <span class="nav-user">
                ...
                <div class="dashboard-main-grid">
                    <div class="dashboard-column dashboard-column-primary">
                        <section class="dashboard-intro">
                            ...
                            <p>View all registered users, their roles, and activation status.</p>
                        </section>
                        ...
                        <section class="user-management-section">
                            <div class="user-management-header">
                                <div>
                                    ...
                                    <p class="user-management-subtitle">Total: <?php echo count($users); ?></p>
                                </div>
                                <div class="user-management-actions">
                                    <a href="register2.php" class="btn btn-small">
                            ...
                            <div class="user-table-wrapper">
                                <table class="user-table">
                                    ...
                                    <tbody>
                                        <?php if (empty($users)): ?>
                                            <tr>
                                                <td colspan="7" style="text-align:center; padding:1.5rem 0;">
                                                    No users found.
                                                </td>
                                            </tr>
                                        <?php else: ?>
                                                            ...
                                                            <form method="post" style="display:inline;">
                                                                ...
                                                                <?php if ($user['is_active']): ?>
                                                                    <button type="submit" class="btn btn-small btn-danger">
                                                                        <i class="fas fa-user-lock"></i> Deactivate
                                                                    </button>
                                                                <?php else: ?>
                            ...
                            <div class="card-grid">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>Create and manage user accounts, roles, and departments.</p>
                                        <p><em>UI for user management can be added here later.</em></p>
                                    </div>
                                </div>

                                <div class="card">
                                    <div class="card-body">
                                        <h3><i class="fas fa-headset"></i> Help Desk Activity</h3>
                                        <p>Monitor ticket volumes, response times, and overall system usage.</p>
                                        <p><em>Reporting and ticket statistics can be integrated here.</em></p>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>Configure departments, categories, and other system-wide settings.</p>
                                        <p><em>Settings screens can be linked from this section.</em></p>
                                    </div>
                                </div>
                            </div>
                        </section>
